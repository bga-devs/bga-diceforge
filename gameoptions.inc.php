...
$game_options = [
    ...
    */
    100 => [
        ...
        'values' => [
            1 => [
                'name' => totranslate('Beginner cards'),
                'tmdisplay' => totranslate('Beginner cards'),
            ],
            99 => [
            ...
            4 => [
                ...
                'description' => totranslate(
                    'Perfect set to discover the expansion'
                ),
            ],
            5 => [
            ...
            12 => [
                ...
                'tmdisplay' => totranslate(
                    '2021 : Challenge of the gods - Final'
                ),
            ],
            13 => [
                'name' => totranslate('2022 : French Cup - Final'),
                'nobeginner' => true,
                'tmdisplay' => totranslate('2022 : French Cup - Final'),
            ],
        ],
        'startcondition' => [
            1 => [
                [
                    ...
                    'value' => '2',
                    'message' => totranslate(
                        'You cannot use this option without a module (necessary to match Beginner cards)'
                    ),
                ],
            ],
            99 => [
                [
                    ...
                    'value' => '2',
                    'message' => totranslate(
                        'You cannot use this option without a module (necessary to match Advanced cards)'
                    ),
                ],
            ],
            2 => [],
            ...
            4 => [
                [
                    ...
                    'value' => '1',
                    'message' => totranslate(
                        'You cannot use this option with the extension disabled'
                    ),
                ],
                [
                    'type' => 'otheroptionisnot',
            ...
            5 => [
                [
                    ...
                    'value' => '1',
                    'message' => totranslate(
                        'You must enable Rebellion with "Cards only" option'
                    ),
                ],
                [
                    'type' => 'otheroptionisnot',
            ...
            11 => [
                ...
                [
                    ...
                    'value' => 2,
                    'message' => totranslate(
                        'This setup is for a 2 players game only'
                    ),
                ],
                [
                    'type' => 'minplayers',
    ...
    103 => [
        ...
        'values' => [
            ...
            1 => [
                ...
                'nobeginner' => true,
                'tmdisplay' => totranslate('with tiebreaker'),
            ],
        ],
    ],
    102 => [
        ...
        'values' => [
            ...
            2 => [
                'name' => totranslate('Cards only'),
                'nobeginner' => true,
                'tmdisplay' => totranslate('extensions card'),
            ],
            3 => [
                'name' => totranslate('Module Titan'),
                'nobeginner' => true,
                'tmdisplay' => totranslate('Titan\'s module'),
            ],
            4 => [
    ...
    101 => [
        ...
        'values' => [
            ...
            1 => [
                'name' => totranslate('Yes'),
                'nobeginner' => true,
                'tmdisplay' => totranslate('with Promo cards'),
            ],
        ],
        'displaycondition' => [
            [

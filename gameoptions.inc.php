    ...
    */
    100 => array(
        ...
        'values' => array(
            ...
            4   => array('name' => totranslate('Recommended (extension)'),   'nobeginner' => true, 'tmdisplay' => totranslate('Recommended set (extension)') ),
            5   => array('name' => totranslate('Perfect for 2 players'),  'nobeginner' => true, 'tmdisplay' => totranslate('setup Perfect for 2 players') ),
            6   => array('name' => totranslate('Again and again'), 'nobeginner' => true, 'tmdisplay' => totranslate('setup Again and again') ),
            7   => array('name' => totranslate('May the forge be with you'),  'nobeginner' => true, 'tmdisplay' => totranslate('setup May the forge be with you') ),
            8   => array('name' => totranslate('Versatility'), 'nobeginner' => true, 'tmdisplay' => totranslate('setup Versatility') ),
            9   => array('name' => totranslate('2020 : Tournament setup 1'),  'nobeginner' => true, 'tmdisplay' => totranslate('2020 : Tournament setup 1') ),
           10   => array('name' => totranslate('2020 : Tournament setup 2'),  'nobeginner' => true, 'tmdisplay' => totranslate('2020 : Tournament setup 2') ),
        ),
    ...
    102 => array(
        ...
        'values' => array(
            ...
            2   => array('name' => totranslate('Cards only'), 'nobeginner' => true,  'tmdisplay' => totranslate('extensions card')),
            3   => array('name' => totranslate('Module Titan'), 'nobeginner' => true, 'tmdisplay' => totranslate('Titan\'s module')),
            4   => array('name' => totranslate('Module Goddess'), 'nobeginner' => true, 'tmdisplay' => totranslate('Goddess\' module') ),
        ),
        'disable' => true,
    ),
    101 => array(

...
$this->decks = [
    ...
    'promo' => ['magicSeagull', 'nymphe', 'hydraPromo'],
    'titan_reco' => [
        'scepter',
        'wind',
        'ancestor',
    ...
    'goddess_mandatory' => ['moonGolem', 'sunGolem', 'timeGolem', 'greatGolem'],
    'rebellion_cards' => [
        'scepter',
        'wind',
        'ancestor',
...
$this->decks['random'] = array_unique(
    array_merge($this->decks['beginner'], $this->decks['alternate'])
);
$this->ressourceToText = [
    'gold' => '[G]',
    'moonshard' => '[MS]',
    'fireshard' => '[FS]',
    'hammer' => '[H]',
...
$boar_power_description = clienttranslate(
    '[hourglass] : Gain 1 [FS], 1 [MS] or 3 [VP] each time the effects of the matching die face are applied'
);
$misfortune_description = clienttranslate(
    '[instant] : Take the face matching this card from the Forest. Choose another player as the bearer of this die face. That player must immediately forge that die face on one of their dice. They cannot remove it until the end of the game.<br /> [hourglass] – <b>activation conditions</b>: Each time that the effects associated to this card are activated.<br />[hourglass] : Apply the effects of both dice of the bearer of the die face as if you were receiving divine blessings.'
);
$misfortune_power_description = clienttranslate(
    '[hourglass] : Apply the effects of both dice of the bearer of the die face as if you were receiving divine blessings.'
);
$memory_description = clienttranslate(
    '[instant] : Take from the reserve the 2 Memory tokens matching the color of this card. Choose a face on each token (2 [AS] + 1 [MS] or 2 [L] + 1 [FS]) then place it with this face-up on any Island. The two tokens must be placed on two different Islands.<br />[hourglass] - <b>activation conditions</b>: When you perform a Heroic feat on an Island that includes one of the tokens matching this card. That token is then discarded.<br />[hourglass] : Gain the reward showed by the token.<br />Note: If some other tokens of other color are on an island (belonging to you or an opponent) you can still place one of your tokens on the same island.'
);
$memory_power_description = clienttranslate(
    'After having performed a Heroic feat on an Island that includes one of the tokens matching this card. Gain the reward showed by the token and then discard it.'
);
...
$this->exploit_types = [
    ...
    'chest' => [
        ...
        'deckOption' => 'all',
        'description' => clienttranslate(
            'A chest is added to your inventory and expands your inventory to 4 [G], 3 [FS] and 3 [MS].'
        ),
    ],
    'doe' => [
        ...
        'deckOption' => 'beginner',
        'description' => clienttranslate(
            '[instant] : No effect.<br />[reinforcement] : You may receive a <b>minor blessing</b>.'
        ),
        'power_description' => clienttranslate(
            'You may receive a <b>minor blessing</b>'
        ),
    ],
    'bear' => [
        ...
        'description' => clienttranslate(
            '[instant] : No effect.<br />[hourglass] : Gain 3 [VP] <b>each time</b> you oust a hero OR you are ousted by another hero'
        ),
        'power_description' => clienttranslate(
            '[hourglass] : Gain 3 [VP] <b>each time</b> you oust a hero OR you are ousted by another hero'
        ),
    ],
    'satyres' => [
        ...
        'deckOption' => 'beginner',
        'description' => clienttranslate(
            'All other players roll their dice, place them back on their Inventory, but do not apply their effects. Then, you choose 2 of the rolled faces and apply their effects, as if receiving a divine blessing.'
        ),
    ],
    'greenBoar' => [
    ...
    'cerberus' => [
        ...
        'deckOption' => 'alternate',
        'description' => clienttranslate(
            'Take a Cerberus single-use token and place it in front of you.<br />After receiving a <b>divine blessing</b> or a <b>minor blessing</b>, you may discard the Cerberus token to apply the result of your rolled dice a second time.<br />When discarded, place the Cerberus token facedown near your card piles.<br />Note: If the die result offers choices, you may choose different options when applying the result the second time.<br />Note 2: You may use only one Cerberus token per die roll.'
        ),
        'power_description' => clienttranslate(
            'Use the token after a die roll to apply the result of your rolled dice a second time. Note: If the die result offers choices, you may choose different options when applying the result the second time.'
        ),
    ],
    'invisible' => [
        ...
        'deckOption' => 'all',
        'description' => clienttranslate(
            'Take a [triple] from the Temple Gardens and immediately <b>forge</b> it onto one of your dice.'
        ),
    ],
    'claw' => [
        ...
        'deckOption' => 'beginner',
        'description' => clienttranslate(
            'Receive 2 <b>divine blessings</b> in a row.'
        ),
    ],
    'sentinel' => [
        ...
        'deckOption' => 'alternate',
        'description' => clienttranslate(
            'Receive 2 <b>divine blessings</b> in a row. Each time you gain [FS] or [MS] you may choose not to add them to your reserve, in which case, gain 2 [VP] per [FS] or [MS].'
        ),
    ],
    'ancient' => [
        ...
        'deckOption' => 'all',
        'description' => clienttranslate(
            '[instant] : No effect.<br />[reinforcement] : You may spend 3 [G] to gain 4 [VP].'
        ),
        'power_description' => clienttranslate(
            'You may spend 3 [G] to gain 4 [VP].'
        ),
    ],
    'grass' => [
    ...
    'owl' => [
        ...
        'deckOption' => 'beginner',
        'description' => clienttranslate(
            '[instant] : No effect.<br />[reinforcement] : Gain 1 [G], 1 [FS] or 1 [MS].'
        ),
    ...
    'triton' => [
        ...
        'deckOption' => 'alternate',
        'description' => clienttranslate(
            'Take a Triton single-use token. Anytime during your turn as the active player, you may discard the Triton token to gain 2 [FS], 2 [MS], or 6 [G]. When discarded, place the Triton token facedown near your card piles.'
        ),
        'power_description' => clienttranslate(
            'Single use token: Anytime during your turn as the active player, you may discard the Triton token to gain 2 [FS], 2 [MS], or 6 [G].'
        ),
    ],
    'mirror' => [
        ...
        'deckOption' => 'all',
        'description' => clienttranslate(
            'Take a [mirror] from the Temple Gardens and immediately <b>forge</b> it onto one of your dice. <br/> When you roll the face, copy the effect(s) of a rolled face on an opponent’s die.<br/>[mirror] + [triple] : First choose which die face to copy and then multiply it.'
        ),
    ],
    'enigma' => [
        ...
        'deckOption' => 'beginner',
        'description' => clienttranslate(
            'Receive 4 <b>minor blessings</b> in a row (use the same die for all 4 blessings).'
        ),
    ],
    'cyclops' => [
        ...
        'deckOption' => 'alternate',
        'description' => clienttranslate(
            'Receive 4 <b>minor blessings</b> in a row.<br />Each time you gain [G], you may choose not to add them to your reserve, in which case, gain 1 [VP] per [G].<br />(Use the same die for all 4 blessings.)'
        ),
    ],
    'hydra' => [
    ...
    'typhon' => [
        ...
        'deckOption' => 'alternate',
        'description' => clienttranslate(
            'Gain 1 [VP] for each die face you <b>forged</b> since the start of the game. (Refer to the number of discarded die faces in front of you.)'
        ),
    ],
    'nymphe' => [
        ...
        'deckOption' => 'promo',
        'description' => clienttranslate(
            '[instant] : No effect.<br />[reinforcement] : Get 2 [VP]. If you have 5 [MS] or more, you get 4 [VP] instead.'
        ),
        'power_description' => clienttranslate(
            'Get 2 [VP]. If you have 5 [MS] or more, you get 4 [VP] instead.'
        ),
    ],
    'magicSeagull' => [
        ...
        'deckOption' => 'promo',
        'description' => clienttranslate(
            '[instant]: For the whole of the next <b>turn</b>, each player uses the dice of the player to their right.'
        ),
    ],
    'harpy' => [
    ...
    'hydraPromo' => [
        ...
        'deckOption' => 'promo',
        'description' => clienttranslate(
            'No effect, only [VP]. <br/><b>2 players</b>: Hydra 26 [VP], Harpy 27 [VP] <br/><b>3 players</b>: Hydra 26 [VP], Harpy 27 [VP], Chimera 28 [VP]<br/><b>4 players</b>: Hydra 26 [VP], Harpy 27 [VP], Chimera 28 [VP], Mother of monsters 29 [VP]'
        ),
    ],
    // Rebellion
    // Classical cards
    ...
    'companion' => [
        ...
        'deckOption' => '',
        'description' => clienttranslate(
            '[reinforcement] : Move the Companion token one space forward. Once the token reaches the last space, you can no longer use this [reinforcement] effect.<br />At any time when you’re the Active player, you may decide to gain the resources shown in the space occupied by the Companion token. If you do, the card has no effect for the remainder of the game.<br /><br /><b>Steps</b><br />0 [reinforcement] > 0 [FS] 0 [VP]<br />1 [reinforcement] > 1 [FS] 1 [VP]<br />2 [reinforcement] > 2 [FS] 2 [VP]<br />3 [reinforcement] > 3 [FS] 3 [VP]<br />4 [reinforcement] > 4 [FS] 4 [VP]<br />5 [reinforcement] > 5 [FS] 5 [VP]'
        ),
        'power_description' => clienttranslate(
            'Move the Companion token one space forward. Once the token reaches the last space, you can no longer use this [reinforcement] effect.<br /><br /><b>Steps</b><br />0 [reinforcement] > 0 [FS] 0 [VP]<br />1 [reinforcement] > 1 [FS] 1 [VP]<br />2 [reinforcement] > 2 [FS] 2 [VP]<br />3 [reinforcement] > 3 [FS] 3 [VP]<br />4 [reinforcement] > 4 [FS] 4 [VP]<br />5 [reinforcement] > 5 [FS] 5 [VP]'
        ),
    ],
    'wind' => [
    ...
    'celestial' => [
        ...
        'deckOption' => '',
        'description' => clienttranslate(
            'Roll the Celestial Die once and apply the effect of the rolled face'
        ),
    ],
    'ancestor' => [
        ...
        'deckOption' => '',
        'description' => clienttranslate(
            'You may immediately forge the least expensive die face that shows [VP] from the sanctuary, <b>for free</b>.<br/> Then, gain a <b>minor blessing</b> with the die on which you forged this die face.<br/> Note: A die face shows [VP] if the symbol appears on it.<br />Note 2: If the Sanctuary has run out of die faces that show [VP], then you cannot forge a die face. However, you still receive a <b>minor blessing</b>, with any one of your dice.'
        ),
    ],
    'mists' => [
        ...
        'deckOption' => '',
        'description' => clienttranslate(
            'The player that has the least [G] in their reserves (including you) loses 5 [VP]. Then you gain the 5 [VP] lost by the affected player.<br />Note: if you have less [G] than anyone else, then this card has no effect.<br />Note 2: If the affected player has less than 5 [VP], then they lose as many as possible. You gain only as many [VP] as the affected player actually lost.<br />Note 3: If multiple players are tied for the least [G], all tied players lose 5 [VP] each, and you gain the total amount of lost  [VP].'
        ),
    ],
    'eternalNight' => [
        ...
        'deckOption' => '',
        'description' => clienttranslate(
            'All other players lose 1 [MS] and 1 [FS] from their reserve. You gain these resources.<br />Note: Players simply lose what they can. If a player has 0 [MS] and/or 0 [FS], then they cannot lose them. You only gain as many as the players actually lost.'
        ),
    ],
    'rightHand' => [
        ...
        'deckOption' => '',
        'description' => clienttranslate(
            'Spend as much [G] as you wish from your Hero Inventory reserve and/or from other reserves. Gain 1 [VP] for each [G] spent this way.'
        ),
    ],
    'tree' => [
        ...
        'deckOption' => '',
        'description' => clienttranslate(
            '[reinforcement] : Gain 3 [G] and 1 [VP]. If you have 8 [G] or more in your Hero Inventory reserve, gain 2 [VP] instead. If you have in total 8 [G], you can choose between 3 [G] + 1 [VP] and 2 [VP]'
        ),
        'power_description' => clienttranslate(
            'Gain 3 [G] and 1 [VP]. If you have 8 [G] or more in your Hero Inventory reserve, gain 2 [VP] instead. If you have in total 8 [G], you can choose between 3 [G] + 1 [VP] and 2 [VP]'
        ),
    ],
    'woodNymph' => [
        ...
        'deckOption' => '',
        'description' => clienttranslate(
            'Gain 4 [G], then buy any die face from the Sanctuary, spending its cost in [G], and forge it immediately.'
        ),
    ],
    'merchant' => [
    ...
    'light' => [
        ...
        'deckOption' => '',
        'description' => clienttranslate(
            '[reinforcement] : You may spend 3 [G] to apply the effect of any die face that is currently face-up, whether on your die or that of any other player.'
        ),
        'power_description' => clienttranslate(
            'You may spend 3 [G] to apply the effect of any die face that is currently face-up, whether on your die or that of any other player.'
        ),
    ],
    'goldsmith' => [
        ...
        'deckOption' => '',
        'description' => clienttranslate(
            'Gain 2 [VP] for each different Heroic feat card that you bought since the beginning of the game, including this Heroic feat.'
        ),
    ],
    'omniscient' => [
        ...
        'deckOption' => '',
        'description' => clienttranslate(
            'Gain 2 [VP] for each die face that shows [VP] on your dice.<br />Note: A die face shows [VP] if the symbol appears on it.'
        ),
    ],
    'trident' => [
        ...
        'deckOption' => '',
        'description' => clienttranslate(
            'Spend all of the [G] from your Hero Inventory reserve (but not from any other reserves) and forge a die face from the Temple (Sanctuary or Garden) on one of your dice, for free.<br />Note: Die faces that could be acquired due to the effects of Heroic Feat cards that are available for this game cannot be chosen with this card.<br />Note 2: You can use “The Abyssal Trident” card even if you have 0 in your reserve.'
        ),
    ],
    'eternalFire' => [
        ...
        'deckOption' => '',
        'description' => clienttranslate(
            '<b>Immediately</b> take a new full turn as the active player. You’re the only player to roll dice to receive a divine blessing at the beginning of this turn'
        ),
    ],
    'leftHand' => [
    ...
    'titan' => [
        ...
        'deckOption' => '',
        'description' => clienttranslate(
            'Choose an available Heroic Feat card with a cost of 1 [MS] or 1 [FS]. Perform that Heroic feat without moving your Hero Pawn to the portal. The card’s effects are applied as normal.<br />Note: If there are no more available Heroic Feat cards with a cost of 1 [MS] or 1 [FS] then “The First Titan” card has no effect.<br />Note - <b>Titans module</b>: Completing this Heroic feat may activate the Rebellion zone effect if the player is in this zone and if the activation conditions are met.'
        ),
    ],
    'goddess' => [
        ...
        'deckOption' => '',
        'description' => clienttranslate(
            'Place your dice on your Hero Inventory on the die faces of your choice. Apply the effects of the chosen faces, as if you were receiving a <b>divine blessing</b>.'
        ),
    ],
    'moonGolem' => [
        ...
        'deckOption' => '',
        'description' => clienttranslate(
            'Take a die face [moonGolem] from the Forest and forge it immediately on one of your dice.'
        ),
    ],
    'greatGolem' => [
        ...
        'deckOption' => '',
        'description' => clienttranslate(
            'Move your Golem token two spaces forward on the Goddess Board and apply the effects of each space, in order.'
        ),
    ],
    'sunGolem' => [
        ...
        'deckOption' => '',
        'description' => clienttranslate(
            'Take a die face [sunGolem] from the Forest and forge it immediately on one of your dice.'
        ),
    ],
    'timeGolem' => [
        ...
        'deckOption' => '',
        'description' => clienttranslate(
            'Move your Golem token two spaces backward on the Goddess Board and apply the effects of each space, in order.<br />Note: If you pass through an intersection while moving backward, you are allowed to choose a different path than you chose originally.'
        ),
    ],
    'blueMemory' => [
    ...
    'oracle' => [
        ...
        'deckOption' => '',
        'description' => clienttranslate(
            '[reinforcement] : Receive a <b>minor blessing</b>. Moreover, if you gain [AS] or [L] with this blessing, move the Allegiance tokens of every other players one space to the left (to Rebellion) on the Titans Board.'
        ),
        'power_description' => clienttranslate(
            'Receive a <b>minor blessing</b>. Moreover, if you gain [AS] or [L] with this blessing, move the Allegiance tokens of every other players one space to the left (to Rebellion) on the Titans Board.'
        ),
    ],
    'chaos' => [
        ...
        'deckOption' => '',
        'description' => clienttranslate(
            'Choose a [titanBlueShield][titanRedShield][titanYellowShield][titanGreenShield] die face  among the die faces available in the Forest and forge it immediately on one of your dice.'
        ),
    ],
    'dogged' => [
        ...
        'deckOption' => '',
        'description' => clienttranslate(
            'Choose a die face [G3AS1] [L1V1G2] among the die faces available in the Forest and forge it immediately on one of your dice.'
        ),
    ],
    'guardian' => [
        ...
        'deckOption' => '',
        'description' => clienttranslate(
            '[reinforcement] : Gain 1 [AS] or 1 [L].'
        ),
...
$this->dice_sides = [
    ...
    'blueShield' => [
        ...
        'tooltip' => clienttranslate(
            '> If you gain [MS] on your other die, gain 5 [VP].<br/> > If you gain a different resource, gain 2 [MS]'
        ),
    ],
    'yellowShield' => [
        'type' => 'dependent',
        ...
        'tooltip' => clienttranslate(
            '> If you gain [G] on your other die, gain 5 [VP].<br/> > If you gain a different resource, gain 3 [G]'
        ),
    ],
    'greenShield' => [
        'type' => 'dependent',
        ...
        'tooltip' => clienttranslate(
            '> If you gain [VP] on your other die, gain 5 [VP].<br/> > If you gain a different resource, gain 3 [VP]'
        ),
    ],
    'redShield' => [
        'type' => 'dependent',
        ...
        'tooltip' => clienttranslate(
            '> If you gain [FS] on your other die, gain 5 [VP].<br/> > If you gain a different resource, gain 2 [FS]'
        ),
    ],
    // Rebellion
    'AS1' => [
    ...
    'titanBlueShield' => [
        ...
        'tooltip' => clienttranslate(
            '> If you gain [MS] on your other die, gain 2 [AS] and 3 [VP].<br/> > If you gain a different resource, gain 2 [AS]'
        ),
    ],
    'titanYellowShield' => [
        'type' => 'dependent',
        ...
        'tooltip' => clienttranslate(
            '> If you gain [G] on your other die, gain 2 [L] and 3 [VP].<br/> > If you gain a different resource, gain 2 [L]'
        ),
    ],
    'titanRedShield' => [
        'type' => 'dependent',
        ...
        'tooltip' => clienttranslate(
            '> If you gain [FS] on your other die, gain 2 [AS] and 3 [VP].<br/> > If you gain a different resource, gain 2 [AS]'
        ),
    ],
    'titanGreenShield' => [
        'type' => 'dependent',
        ...
        'tooltip' => clienttranslate(
            '> If you gain [VP] on your other die, gain 2 [L] and 3 [VP].<br/> > If you gain a different resource, gain 2 [L]'
        ),
    ],
    'blueMisfortune' => [
        'type' => 'choice',
...
$this->celestialInfo = [
    ...
    'description' => clienttranslate(
        '[G12] Gain 12 [G]<br />[V5] Gain 5 [VP]<br />[V3G3orFS1orMS1] Gain 3 [VP] and choose 3 [G] or 1 [MS] or 1 [FS]<br />[celestialMirror] Apply the effect(s) of one of your opponents’ dice, or one of your own dice<br />[chooseSide] Choose a die face from one of your dice, place it face up and apply its effect.<br />[doubleUpgrade] Upgrade one of your dice face by two levels at once. Upgrading a die face means that you can replace it with a die face from a higher pool for free. The level of a pool is determined by the cost of the face.<br />To upgrade a die face by one level, choose one of your die faces, then take a die face from the pool of the next level. You may now forge that die face.<br />Note: If the chosen face has no equivalent in the Sanctuary, then it is considered a level 0.<br />Note 2: If the pool from which you would take your upgraded die face is empty, then choose a die face from the next non-empty pool.'
    ),
];
...
$this->powers = [
    ...
    'steal2' => clienttranslate(
        'chooses two opponents dices and get displayed resources'
    ),
    ...
    'fullThrow2Transform' => clienttranslate(
        'gets 2 divine blessings and may convert each [MS] and [FS] into 2 [VP] (Sentinel)'
    ),
    ...
    'looseThrow' => clienttranslate(
        'will make the other players loose their throw'
    ),
    ...
    '4ThrowsTransform' => clienttranslate(
        'gets 4 minor blessings and may convert each [G] into 1 [VP] (Cyclops)'
    ),
    'scoreForgedSides' => clienttranslate(
        'gets 1 [VP] for each of his discarded side(s)'
    ),
    ...
    'sideMisfortune' => clienttranslate(
        'chooses a player that will forge the side'
    ),
];
...
$this->powers_you = [
    ...
    'increaseResLimit' => clienttranslate(
        'you increase your resources max limit'
    ),
    'throw1' => clienttranslate('you get a minor blessing'),
    'steal2' => clienttranslate(
        'you choose two opponents dices and get displayed resources'
    ),
    'boarForge' => clienttranslate(
        'you choose a player that will forge the side'
    ),
    ...
    'fullThrow2Transform' => clienttranslate(
        'you get 2 divine blessings and may convert each [MS] and [FS] into 2 [VP] (Sentinel)'
    ),
    ...
    'looseThrow' => clienttranslate(
        'you will make the other players loose their throw'
    ),
    ...
    '4ThrowsTransform' => clienttranslate(
        'you get 4 minor blessings and may convert each [G] into 1 [VP] (Cyclops)'
    ),
    'scoreForgedSides' => clienttranslate(
        'you get 1 [VP] for each of his discarded side(s)'
    ),
...
$treasure = clienttranslate(
    'If you are the first player to reach this spot, take one of the available Treasure tokens of your choice and gain the highest reward'
);
...
$this->maze = [
    ...
    7 => [
        ...
        'needChoice' => false,
        'description' => clienttranslate(
            'All players (except you) lose 2 [VP]. You then gain the total amount of lost [VP]'
        ),
    ],
    8 => [
        'path' => [13],
    ...
    10 => [
        ...
        'needChoice' => false,
        'description' => clienttranslate(
            'You may immediately forge a die face from the Sanctuary if you spend the required [G], -2 [G]'
        ),
    ],
    11 => [
        'path' => [12],
    ...
    18 => [
        ...
        'needChoice' => false,
        'description' => clienttranslate(
            'You may immediately forge a die face from the Sanctuary if you spend the required [G].'
        ),
    ],
    19 => [
        'path' => [20, 12],
    ...
    27 => [
        ...
        'needChoice' => false,
        'description' => clienttranslate(
            'You may spend 6 [G] to gain 6 [VP] (once).'
        ),
    ],
    28 => [
        'path' => [29],
    ...
    29 => [
        ...
        'needChoice' => false,
        'description' => clienttranslate(
            'You may spend 2 [MS] to gain 8 [VP] (once).'
        ),
    ],
    30 => [
        'path' => [31],
    ...
    33 => [
        ...
        'needChoice' => false,
        'description' => clienttranslate(
            'Gain 1 [VP] for each die face that you have forged'
        ),
    ],
    34 => [
        'path' => [35],
    ...
    'firstFinish' => [
        ...
        'needChoice' => false,
        'description' => clienttranslate(
            'If you are the first player to reach the Goddess space:<br />Place your dice on your Hero Inventory on the die faces that you wish. Apply the effects of the chosen faces, as if you were receiving a <b>divine blessing</b>.'
        ),
    ],
];
...
$this->titan_passives = [
    'titanPassive1' => [
        'description' => clienttranslate(
            '[hourglass] - <b>activation conditions</b>: When you are the first one to perform a Heroic feat in this game.<br />[hourglass]: Gain 5 [VP].<hr />[hourglass] - <b>activation conditions</b>: When you are not and if you did not perform it during this game<br />[hourglass]: Gain 3 [VP].'
        ),
    ],
    'titanPassive2' => [
        'description' => clienttranslate(
            '[hourglass] - <b>activation conditions</b>: When you are the first one to perform a Heroic feat in this game.<br />[hourglass]: Gain 3 [VP].<hr />[hourglass] - <b>activation conditions</b>: When you are not and if you did not perform it during this game<br />[hourglass]: Gain 2 [VP].'
        ),
    ],
    'loyaltyPassive1' => [

...
$this->decks = array(
    ...
    "promo" => array ("magicSeagull", "nymphe", "hydraPromo", 'pegasus', 'wheelFortune'),
...
$this->exploit_types = array (
	...
	"shadowgoddess" => array(
		'name'       => clienttranslate("Goddess Shadow"),
		'VP'         => 30,
		'actionType' => '',
		'position'   => 'M8',
		'costFire'   => 5,
    ...
    "hydraPromo" => array(
		'name'       => clienttranslate("Harpy, Chimera, Mother of Monsters, Goddess Shadow"),
		'VP'         => 0,
		'actionType' => '',
		'position'   => 'M8',
		'costFire'   => 5,
   ...
   'trident' => array(
	...
	// New promo cards
	'wheelFortune'=> array(
        'name' => clienttranslate("The Wheel of fortune"),
        'VP' => 6,
        'actionType' => 'immediate',
        'position' => 'F5',
        'costFire' => 4,
        ...
        'action' => 'fortuneWheel',
        'deckOption' => 'promo',
        'description' => clienttranslate("[instant] : receive divine blessings once except in this one case:<br />before rolling all the dice, pick and declare a roll outcome for each dice among all the likely outcomes on your dice. <br />Win 8 [VP] if only one out of the two faces matches. <br />Win 20 [VP] if both faces match the declared outcomes. <br />NB: applying a declared outcome thanks to a Mirror face doesn’t change the Mirror face kind. Therefore, you need to declare the Mirror face before so you can get bonus . The same applies to every other special face."),
        'power_description' => '',
	),
	'pegasus'=> array(
		...
		'action' => '',
		'deckOption' => 'promo',
		'description' => clienttranslate("TODO"),
		'power_description' => 'TODO',
	),
	'cornucopia'=> array(
		'name' => clienttranslate("cornucopia"),
		'VP' => 10,
		'actionType' => 'immediate',
		'position' => 'M3',
		'costFire' => 0,
	...
	'dicetower'=> array(
		'name' => clienttranslate("Dice Tower"),
		'VP' => 0,
		'actionType' => 'immediate',
		'position' => 'F3',
		'costFire' => 0,

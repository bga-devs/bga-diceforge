...
/**
 * BGA Framework Stubs for Unit Testing
 * Consolidated from table.game.php, deck.game.php, game.view.php
 *
 * This file provides in-memory stub implementations of the BGA framework classes
 * for running PHPUnit tests without a database or the real framework.
 */
...
// ============================================================================
// Bga\GameFramework\Actions\Types
// ============================================================================
...
namespace Bga\GameFramework\States {
    ...
    abstract class GameState
    {
        ...
        public function __construct(
            ...
            if ($name == null) {
                $this->name = substr(strrchr(get_class($this), '\\') ?: get_class($this), 1);
            }
        }
...
// ============================================================================
// Bga\GameFramework (main namespace)
// ============================================================================
...
namespace Bga\GameFramework {
    ...
    // ---- Notify (concrete, with in-memory implementation) ----
    ...
    class Logs
    {
         ...
         */
        public function remove(int $startMoveId): void
        {
        }
    }

    // ---- Legacy (concrete, with in-memory storage) ----
    ...
    // ---- GamestateMachine (concrete, with in-memory state tracking) ----
    ...
    class GamestateMachine
    {
        ...
        public function _setStates($states = [])
        {
            $this->states = $states;
        }

        public function getStateNumberByTransition($transition)
        {
            $state = $this->state();
         ...
         */
        public function isMultiactiveState(): bool
        {
            $state = $this->state();
    ...
    class Table
    {
        ...
        protected function _createPlayerCounterStub(): Components\Counters\PlayerCounter
        {
            return new Components\Counters\StubPlayerCounter();
        }
         ...
         */
        public function getCurrentPlayerName($bReturnEmptyIfNotLogged = false): string
        {
            return '';
        }
         ...
         */
        public function isCurrentPlayerZombie(): bool
        {
            return false;
        }
         ...
         */
        public function getPlayerNoById(int $player_id): int|string
        {
            $players = self::loadPlayersBasicInfos();
         ...
         */
        public function getPlayerColorById(int $player_id): string
        {
            $players = self::loadPlayersBasicInfos();
         ...
         * @return void
         */
        public function eliminatePlayer(int $player_id): void
        {
        }
         ...
         * @return array<int, int>
         */
        public function getPrevPlayerTable(): array
        {
            $players = $this->loadPlayersBasicInfos();
         ...
         * @return array<int, int>
         */
        public function createNextPlayerTable(array $players, bool $bLoop = true)
        {
            $player_table = [];
        ...
        {
            $this->_gameStateValues[$label] = $value;
        }
        ...
        {
            return $this->_gameStateValues[$label] ?? $default ?? 0;
        }
        ...
        {
            $this->_gameStateValues[$label] = ($this->_gameStateValues[$label] ?? 0) + $increment;
            return $this->_gameStateValues[$label];
        }
        ...
        public function doUndoSavePoint()
        {
        }
         ...
         * @return int the new active player id
         */
        public function activePrevPlayer(): void
        {
        }
         ...
         */
        public function checkAction(string $actionName, bool $bThrowException = true): bool
        {
            return true;
        }
         ...
         */
        public function getStat(string $name, ?int $player_id = null): int
        {
            return 0;
        }
        ...
        public function getAllTableDatas()
        {
            return [];
        }
         ...
         */
        public function logTextForModeration(int $player_id, string $message): void
        {
        }
        ...
        // Legacy data methods (deprecated)
...
namespace Bga\GameFramework\Db {
    class Globals
    {
        ...
        {
            $this->data[$name] = ($this->data[$name] ?? 0) + $step;
...
// ============================================================================
// Bga\GameFramework\Components\Counters
// ============================================================================
...
namespace Bga\GameFramework\Components\Counters {
    ...
    abstract class PlayerCounter
    {
        ...
        {
            $this->values[$playerId] = ($this->values[$playerId] ?? 0) + $inc;
        ...
        {
            return empty($this->values) ? 0 : min($this->values);
        }
        ...
        {
            return empty($this->values) ? 0 : max($this->values);
        }
...
namespace {
    ...
    // --- Global Table (backward compat alias) ---
    ...
    // --- Global Deck (full in-memory implementation from deck.game.php) ---
    ...
    class Deck extends APP_GameClass
    {
        ...
        public function reformDeckFromDiscard($from_location = 'deck')
        {
            self::checkLocation($from_location);
        }
         ...
         */
        public function getCardsOfTypeInLocation(mixed $type, ?int $type_arg, string $location, ?int $location_arg = null): array
        {
            return [];
        }
        ...
        final public function checkLocation(string $location, bool $like = false)
        {
            if ($location == null) {
        ...
        final public function checkLocationArg($location_arg, $canBeNull = false)
        {
    ...
    // --- Global GameState (old pre-namespace version, backward compat) ---
    ...
    class GameState
    {
        ...
        public function jumpToState($stateNum)
        {
        ...
        public function getPrivateState($playerId)
        {
            return $this->private_states[$playerId] ?? null;
        }

        public function nextPrivateStateForPlayers($ids, $transition)
        {
        }
        ...
        public function initializePrivateStateForPlayers($ids)
        {
        }
        ...
        public function unsetPrivateStateForPlayers($ids)
        {
        }
    ...
    // --- View classes (from game.view.php) ---
    ...
    class APP_Template
    {
        ...
        public function insert_template($target_variable, $template_name, $tpl_variable_table)
        {
        }

        public function reset_subblocks($subblock_name)
        {
        }
    }
    ...
    define('AT_bool', 5);
    define('AT_enum', 6);
    define('AT_alphanum', 7);
    define('AT_username', 8);
    define('AT_login', 9);
    define('AT_numberlist', 13);
    define('AT_uuid', 17);
    define('AT_version', 18);
    define('AT_cityname', 20);
    define('AT_filename', 21);
    define('AT_groupname', 22);
    define('AT_timezone', 23);
    define('AT_mediawikipage', 24);
    define('AT_html_id', 26);
    define('AT_alphanum_dash', 27);
    define('AT_date', 28);
    define('AT_num', 29);
    define('AT_alpha_strict', 30);
    define('AT_namewithaccent', 31);
    define('AT_json', 32);
    define('AT_base64', 33);
